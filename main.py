...
from PyQt5.QtWidgets import QApplication, QMainWindow, QMessageBox, QFileDialog, QWidget, QGridLayout, QTextEdit, QDirModel,QTabWidget
...
class Notebook(QMainWindow, Ui_CodePlus):
    ...
    def new_terminal_event(self):
        ...
        self.dock_tab.addTab(self.new_tab, 'Terminal ' + str(self.teridx))
        index = self.dock_tab.count() - 1
        self.dock_tab.setCurrentIndex(index)
